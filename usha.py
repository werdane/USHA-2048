...
I am not liable for any issues or bugs presented within the code. You are free to use and or modify the code to 
suit your needs, this can be used commercially.

Avg. hashing speed: 45.31 seconds || Varies depending on the length of password.
"""
...
def usha2048(data):
    data = hash_message(second_defense(first_defense(data))) # Hash wrapping?
    return data
